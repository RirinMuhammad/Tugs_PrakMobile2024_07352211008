        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Menutup drawer
                // Tambahkan navigasi ke halaman Profile
              },
            ),
            ListTile(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        gradient: const LinearGradient(
          colors: [Color(0xFFE0EAFC), Color.fromARGB(255, 76, 130, 175)],
        ),
      ),
      child: Row(
    ...
    return Row(
      ...
      children: [
        ...
        TextButton(
          ...
          child: const Text(
            "View All",
            style: TextStyle(color: Color.fromARGB(255, 76, 130, 175)),
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'assets/images/sepatu1.png',
          name: ' Shoe',
          role: 'Beautician',
        ...
        ServiceCard(
          imageUrl: 'assets/images/sepatu3.png',
          name: 'Shoe',
          role: 'Beautician',
          description: 'Doloribus saepe aut necessitatibus qui.',
          rating: 4.9,
    ...
    return Column(
        children: [
          BestBookingCard(
            ...
            profileUrl: 'assets/images/p1.png',
          ...
          BestBookingCard(
            ...
            profileUrl: 'assets/images/p2.png',
            name: 'Miss Zachary Will',
            role: 'Beautician',
            description: 'Occaecati aut nam beatae quo non deserunt consequatur.',
            rating: 4.9,
            ...
            child: Row(
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.star, color: const Color.fromARGB(255, 76, 130, 175), size: 16),
                      SizedBox(width: 4),
                      Text(
                        rating.toString(),
                        style: TextStyle(
            ...
            Stack(
              children: [
                ClipRRect(
                  ...
                  child: Image.asset(
                    'assets/images/sepatu1.png', // Ganti dengan path gambar Anda
                    height: 230,
                    width: double.infinity,
                    fit: BoxFit.cover,
                  ),
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.star, color: const Color.fromARGB(255, 253, 192, 38), size: 16),
                        SizedBox(width: 4),
                        Text( 
                          "4.9",
                          style: TextStyle(
